...
if __name__ == "__main__":
    ...
    config = {'sigma_list': [15, 80, 250], 'G': 5.0, 'b': 25.0, 'alpha': 125.0, 'beta': 46.0, 'low_clip': 0.01, 'high_clip': 0.99}

    # data_path = '/home/zyl/SRDLEndoTrack/MySiamBAN/training_dataset/my_endos/images_light2/cam1video_2023-02-22_16-13-25'
    # data_path = '/home/zyl/SRDLEndoTrack/MySiamBAN/training_dataset/my_endos/images_light2/cam1video_2023-01-16_22-43-41'
    data_path = '/home/zyl/SRDLEndoTrack/SRDL-MVSendovis/sample_retinex'
    ...
    for img_name in img_list:
        ...
        img_msrcr = MSRCR(img, config['sigma_list'], config['G'], config['b'], config['alpha'], config['beta'], config['low_clip'], config['high_clip'])

        img_amsrcr = automatedMSRCR(img, config['sigma_list'])

        img_msrcp = MSRCP(img, config['sigma_list'], config['low_clip'], config['high_clip'])
