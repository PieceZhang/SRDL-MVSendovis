...
img_list = []
input_path = r"D:\B_SRDL\SRDL-MVSendovis\imgcap\cam2"  # 要处理的图片所在的文件夹
output_path = r"D:\B_SRDL\SRDL-MVSendovis\imgcap\cam2_gray"  # 处理完的图片放在这里
...
for imagepath in img_list:
    ...
    print(output_path + '%d.jpg' % count)  # 显示保存文件的路径及保存的文件名
